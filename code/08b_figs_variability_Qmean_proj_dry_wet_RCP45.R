...
#### OUTPUTS ####
# Wet season outputs
file_plot_precipmethod_1_wet <- "output/08_plots_results/fig_variability_dueto_precipestimation_1_RCP45_wet.pdf"
file_plot_precipmethod_2_wet <- "output/08_plots_results/fig_variability_dueto_precipestimation_2_RCP45_wet.pdf"
...
file_plot_hydromodel_1_wet <- "output/08_plots_results/fig_variability_dueto_hydromodel_1_RCP45_wet.pdf"
file_plot_hydromodel_2_wet <- "output/08_plots_results/fig_variability_dueto_hydromodel_2_RCP45_wet.pdf"

# Dry season outputs
file_plot_precipmethod_1_dry <- "output/08_plots_results/fig_variability_dueto_precipestimation_1_RCP45_dry.pdf"
file_plot_precipmethod_2_dry <- "output/08_plots_results/fig_variability_dueto_precipestimation_2_RCP45_dry.pdf"
...
file_plot_hydromodel_1_dry <- "output/08_plots_results/fig_variability_dueto_hydromodel_1_RCP45_dry.pdf"
file_plot_hydromodel_2_dry <- "output/08_plots_results/fig_variability_dueto_hydromodel_2_RCP45_dry.pdf"
...
process_season_data <- function(df_input, season_name) {
  ...
  # Calculate changes for RCP 4.5 only
...
create_plot_2_alt(wet_data, "Wet Season", file_plot_precipmethod_2_alt_rcp45_wet)
...
create_plot_2_alt(dry_data, "Dry Season", file_plot_precipmethod_2_alt_rcp45_dry)
