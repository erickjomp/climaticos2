...
#### OUTPUTS ####
# Wet season outputs
file_plot_precipmethod_1_wet <- "output/08_plots_results/fig_variability_dueto_precipestimation_1_wet.pdf"
file_plot_precipmethod_2_wet <- "output/08_plots_results/fig_variability_dueto_precipestimation_2_wet.pdf"
file_plot_precipmethod_2_alt_rcp45_wet <- "output/08_plots_results/fig_variability_dueto_precipestimation_2_alternative_RCP45_wet.pdf"
...
file_plot_hydromodel_1_wet <- "output/08_plots_results/fig_variability_dueto_hydromodel_1_wet.pdf"
file_plot_hydromodel_2_wet <- "output/08_plots_results/fig_variability_dueto_hydromodel_2_wet.pdf"

# Dry season outputs
file_plot_precipmethod_1_dry <- "output/08_plots_results/fig_variability_dueto_precipestimation_1_dry.pdf"
file_plot_precipmethod_2_dry <- "output/08_plots_results/fig_variability_dueto_precipestimation_2_dry.pdf"
file_plot_precipmethod_2_alt_rcp45_dry <- "output/08_plots_results/fig_variability_dueto_precipestimation_2_alternative_RCP45_dry.pdf"
...
file_plot_hydromodel_1_dry <- "output/08_plots_results/fig_variability_dueto_hydromodel_1_dry.pdf"
file_plot_hydromodel_2_dry <- "output/08_plots_results/fig_variability_dueto_hydromodel_2_dry.pdf"
...
process_season_data <- function(df_input, season_name) {
  ...
  return(list(rcp45 = df_Qy_change45, rcp85 = df_Qy_change85))
}

#### FUNCTION TO CREATE PLOTS ####
create_plot_1 <- function(df_plot, season_label, file_output) {
  stats_plot <- get_facet_stats(df_plot, c("scenario", "hmodel"), "source_pr")
  minmax_plot <- get_minmax_lines(df_plot, c("scenario", "hmodel"), "source_pr")
...
create_plot_2 <- function(df_plot, season_label, file_output) {
  stats_plot <- get_facet_stats(df_plot, c("scenario", "hmodel"), "GCM")
  minmax_plot <- get_minmax_lines(df_plot, c("scenario", "hmodel"), "GCM")
...
create_plot_2_alt <- function(df_plot, scenario_label, season_label, file_output) {
...
create_plot_3 <- function(df_plot, season_label, file_output) {
  stats_plot <- get_facet_stats(df_plot, c("scenario", "source_pr"), "hmodel")
  minmax_plot <- get_minmax_lines(df_plot, c("scenario", "source_pr"), "hmodel")
...
create_plot_4 <- function(df_plot, season_label, file_output) {
  stats_plot <- get_facet_stats(df_plot, c("scenario", "source_pr"), "GCM")
  minmax_plot <- get_minmax_lines(df_plot, c("scenario", "source_pr"), "GCM")
  ...
  p <- df_plot %>%
    ...
    geom_segment(data = minmax_plot, aes(x = GCM, xend = GCM, 
                                         y = min_val, yend = max_val),
                 inherit.aes = FALSE, color = "grey30", linewidth = 0.5, alpha = 0.4) +
    geom_segment(data = minmax_plot, aes(x = as.numeric(GCM) - 0.38, xend = as.numeric(GCM) + 0.38, 
                                         y = min_val, yend = min_val),
                 inherit.aes = FALSE, color = "grey70", linewidth = 0.5) +
    geom_segment(data = minmax_plot, aes(x = as.numeric(GCM) - 0.38, xend = as.numeric(GCM) + 0.38, 
                                         y = max_val, yend = max_val),
...
df_wet_combined <- rbind(wet_data$rcp45, wet_data$rcp85)

# Plot 1 - Wet
cat("Creating Plot 1 - Wet Season...\n")
create_plot_1(df_wet_combined, "Wet Season", file_plot_precipmethod_1_wet)

# Plot 2 - Wet
cat("Creating Plot 2 - Wet Season...\n")
create_plot_2(df_wet_combined, "Wet Season", file_plot_precipmethod_2_wet)

# Plot 2 Alt RCP 4.5 - Wet
cat("Creating Plot 2 Alternative RCP 4.5 - Wet Season...\n")
create_plot_2_alt(wet_data$rcp45, "RCP 4.5", "Wet Season", file_plot_precipmethod_2_alt_rcp45_wet)

# Plot 2 Alt RCP 8.5 - Wet
cat("Creating Plot 2 Alternative RCP 8.5 - Wet Season...\n")
create_plot_2_alt(wet_data$rcp85, "RCP 8.5", "Wet Season", file_plot_precipmethod_2_alt_rcp85_wet)

# Plot 3 - Wet
cat("Creating Plot 3 - Wet Season...\n")
create_plot_3(df_wet_combined, "Wet Season", file_plot_hydromodel_1_wet)

# Plot 4 - Wet
cat("Creating Plot 4 - Wet Season...\n")
create_plot_4(df_wet_combined, "Wet Season", file_plot_hydromodel_2_wet)

## DRY SEASON PLOTS ##
cat("\n=== Processing DRY SEASON (May - October) ===\n")
dry_data <- process_season_data(df_all, "dry")
df_dry_combined <- rbind(dry_data$rcp45, dry_data$rcp85)

# Plot 1 - Dry
cat("Creating Plot 1 - Dry Season...\n")
create_plot_1(df_dry_combined, "Dry Season", file_plot_precipmethod_1_dry)

# Plot 2 - Dry
cat("Creating Plot 2 - Dry Season...\n")
create_plot_2(df_dry_combined, "Dry Season", file_plot_precipmethod_2_dry)

# Plot 2 Alt RCP 4.5 - Dry
cat("Creating Plot 2 Alternative RCP 4.5 - Dry Season...\n")
create_plot_2_alt(dry_data$rcp45, "RCP 4.5", "Dry Season", file_plot_precipmethod_2_alt_rcp45_dry)

# Plot 2 Alt RCP 8.5 - Dry
cat("Creating Plot 2 Alternative RCP 8.5 - Dry Season...\n")
create_plot_2_alt(dry_data$rcp85, "RCP 8.5", "Dry Season", file_plot_precipmethod_2_alt_rcp85_dry)

# Plot 3 - Dry
cat("Creating Plot 3 - Dry Season...\n")
create_plot_3(df_dry_combined, "Dry Season", file_plot_hydromodel_1_dry)

# Plot 4 - Dry
cat("Creating Plot 4 - Dry Season...\n")
create_plot_4(df_dry_combined, "Dry Season", file_plot_hydromodel_2_dry)

cat("\n=== All 12 plots completed successfully! ===\n")
