...
#### OUTPUTS ####
file_plot_precipmethod_1 <- "output/08_plots_results/fig_variability_dueto_precipestimation_1_RCP85.pdf"
file_plot_precipmethod_2 <- "output/08_plots_results/fig_variability_dueto_precipestimation_2_RCP85.pdf"
